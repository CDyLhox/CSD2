...
- Run the code, read the code and answer the following question:
  ...
  first you calculate the quarterNote by calculating the beats per minute per minute. 
  you also make 2 variables, how many quarternotes to a bar(in this case 3), and also how many stepsPerQuarterNote(which is in this case 4(16ths))
  
  you calculate the stepduration by calculatin the steps per quarternote (quarternote/4)
  and the stepsperbar is the times of stepsPerQuarterNote and quarterNotesPerBar which is the oppisite of the calculation above to balence out.
